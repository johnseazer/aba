...
# original : https://wilkelab.org/classes/SDS348/2018_spring/labs/lab13-solution.html
...
git_url = 'https://github.com/e-ditiones/PARALLEL17.git'
repo_dir = 'PARALLEL17'
...
def treat_seq(seq):
  for i in range(len(seq)):
    seq[i] = separate_apostrophe(seq[i])
    seq[i] = concatenate_que(seq[i])
    seq[i] = remove_punctuation(seq[i])
    seq[i] = split_sequence(seq[i])
